...
class ProductCard extends Component {
  ...
  handleProductsRemoveFromCart = () => {
    this.props.removeCartFromProductsPage(this.props.id);
  };
        ...
        {this.props.cart === true ? (
          <div className="cart-buttons">
            ...
            <IconButton
              color="primary"
              variant="outlined"
              onClick={() => this.props.onQuantityChange(id, 1)}
            >
              {" "}
              <AddIcon />{" "}
            </IconButton>
            ...
            <Button
              variant="contained"
              onClick={() => this.props.onRemoveCart(id)}
              color="tertiary"
              sx={{
                color: "white",
              }}
          ...
          <div className="product-button">
            {this.props.addedToCart ? (
              <Button
                ...
                onClick={this.handleProductsRemoveFromCart}
              >
                Remove From cart
              </Button>
            ) : (
              <Button
                ...
                disabled={this.props.addedToCart}
              >
                Add to cart
              </Button>
            )}
